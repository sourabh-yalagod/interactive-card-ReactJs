  ...
  return (
    <div className="relative sm:h-screen">
      ...
      <div className="absolute top-10 right-3 sm:top-80 sm:right-[-50px] md:right-[-80px] lg:right-[-130px]  hover:scale-95 transition-all">
        ...
        <div className="absolute right-7 top-[39%] sm:right-9 sm:top-[41%] text-white text-[17  px] font-semibold tracking-widest">
          {formData.cvv || '000'}
        </div>
      </div>
      <div className="absolute top-24 sm:top-40 left-4 sm:right-[-10px] md:right-[-50px] lg:right-[-100px]  hover:scale-95 transition-all">
